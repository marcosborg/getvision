                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.tvde-activities.update", [$tvdeActivity->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('bonus') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="bonus" id="bonus" value="{{ old('bonus', $tvdeActivity->bonus) }}" step="0.01">
                            @if($errors->has('bonus'))
                        ...
                        <div class="form-group {{ $errors->has('tolls') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="tolls" id="tolls" value="{{ old('tolls', $tvdeActivity->tolls) }}" step="0.01">
                            @if($errors->has('tolls'))
                        ...
                        <div class="form-group {{ $errors->has('parks') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="parks" id="parks" value="{{ old('parks', $tvdeActivity->parks) }}" step="0.01">
                            @if($errors->has('parks'))
